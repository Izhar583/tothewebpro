...
export default async function BlogIndexPage() {
  ...
  return (
    <div className="mx-auto max-w-8xl px-4 py-12 md:py-20">
      ...
      {featuredPost && (
        <div className="mb-16">
          <article className="rounded-3xl border border-slate-200 bg-white p-8 md:p-12  transition-all duration-300 hover:border-orange-200 group relative overflow-hidden flex flex-col md:flex-row gap-8 items-center">
      ...
      {/* Other Posts */}
      <h3 className="text-2xl font-bold text-slate-900 mb-8 border-b border-slate-200 pb-4">More Articles</h3>
      <ul className="grid md:grid-cols-2 gap-8">
        {otherPosts.map((post) => (
          <li key={post.slug}>
            <article className="h-full rounded-3xl border border-slate-200 bg-white p-8 transition-all duration-300 hover:-translate-y-1 hover:border-orange-200 group relative overflow-hidden flex flex-col">
