      ...
      <div className="space-y-6">
        ...
        <section className="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm hover:border-emerald-200 transition-colors">
          ...
          <p className="text-slate-600 leading-relaxed pl-14">
            ...
            <a href="mailto:tothewebpro@gmail.com" className="font-semibold text-emerald-600 hover:text-emerald-700 underline underline-offset-2">
        ...
        <section className="bg-slate-900 rounded-3xl p-8 border border-slate-800 text-center relative overflow-hidden">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center">
            ...
            <a href="mailto:tothewebpro@gmail.com" className="inline-flex items-center justify-center px-6 py-3 rounded-xl bg-cyan-500 hover:bg-cyan-400 text-slate-900 font-bold transition-colors">
              tothewebpro@gmail.com
            </a>
          </div>
        </section>
