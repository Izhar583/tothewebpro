      ...
      <div className="space-y-6">
        ...
        <section className="bg-slate-900 rounded-3xl p-8 border border-slate-800 text-center relative overflow-hidden mt-6">
          ...
          <div className="relative z-10 flex flex-col items-center justify-center">
            ...
            <a href="mailto:contact@tothewebpro.com" className="inline-flex items-center justify-center px-6 py-3 rounded-xl bg-blue-500 hover:bg-blue-400 text-slate-900 font-bold transition-colors">
