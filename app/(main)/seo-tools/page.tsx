    ...
    <div className="w-full">
      ...
      <header className="pb-8 border-b border-slate-200/80">
        ...
        <nav aria-label="Breadcrumb" className="flex items-center gap-2 text-sm text-slate-500 font-medium mb-6">
          ...
          <span className="text-slate-900 font-semibold">SEO Tools</span>
        </nav>
        ...
        <div className="max-w-3xl">
          ...
          <p className="mt-4 text-base sm:text-lg text-slate-600 font-normal leading-relaxed">
            Lightweight, browser-based utilities to test meta tags, inspect heading hierarchies, validate JSON-LD structured data, and audit Core Web Vitals.
          </p>
        </div>
      </header>

      {/* Catalog Section */}
      <section className="pt-10" aria-labelledby="seo-tools-grid-heading">
        <div className="flex items-center justify-between mb-8">
          <h2 id="seo-tools-grid-heading" className="text-xl font-bold text-slate-900">
